...
const NormalSettingBody = t.Object({
  ...
  lineGroupAgentLockedMessage: t.Optional(t.String()),
  lineGroupVipLockedMessage: t.Optional(t.String()),
  welcomeTitle: t.Optional(t.String()),
  welcomeAgentDesc: t.Optional(t.String()),
  welcomeVipDesc: t.Optional(t.String()),
  welcomeMemberDesc: t.Optional(t.String()),
  agentSignupTitle: t.Optional(t.String()),
  agentSignupDescription: t.Optional(t.String()),
  vipSignupTitle: t.Optional(t.String()),
  vipSignupDescription: t.Optional(t.String()),
      ...
      const saved = existing
         ...
         : await prisma.config.create({
             data: {
               ...
               lineGroupAgentLockedMessage:
                 body.lineGroupAgentLockedMessage ?? "",
               lineGroupVipLockedMessage:
                 body.lineGroupVipLockedMessage ?? "",
               welcomeTitle: body.welcomeTitle ?? "",
               welcomeAgentDesc: body.welcomeAgentDesc ?? "",
               welcomeVipDesc: body.welcomeVipDesc ?? "",
               welcomeMemberDesc: body.welcomeMemberDesc ?? "",
               agentSignupTitle: body.agentSignupTitle ?? "",
               agentSignupDescription: body.agentSignupDescription ?? "",
               vipSignupTitle: body.vipSignupTitle ?? "",
               vipSignupDescription: body.vipSignupDescription ?? "",
