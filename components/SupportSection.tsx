...
export default function SupportSection() {
  return (
    <section className="bg-white py-20" id="support">
      <div className="max-w-[1240px] mx-auto px-7 w-full relative">
        <div className="relative overflow-hidden rounded-[36px] bg-gradient-to-br from-brand-gold to-brand-gold-deep p-8 md:p-14 shadow-2xl flex flex-col lg:flex-row lg:items-center justify-between gap-10">
          ...
          <span className="absolute -top-40 -right-20 h-[340px] w-[340px] rounded-full bg-white/16 pointer-events-none" />
          <span className="absolute -bottom-[110px] left-[30%] h-48 w-48 rounded-full bg-white/12 pointer-events-none" />

          {/* Left Column Support info */}
          <div className="space-y-4 max-w-xl relative z-10">
            <span className="inline-flex items-center gap-2 bg-white/90 text-brand-gold-deep font-extrabold text-[13.5px] py-2 px-4.5 rounded-full shadow-sm">
          ...
          <div className="flex flex-col gap-3.5 w-full lg:max-w-xs relative z-10">
            ...
            <a 
              ...
              className="flex items-center gap-4 bg-white/95 rounded-2xl p-4 md:py-4.5 md:px-5.5 font-extrabold text-sm.5 text-brand-ink transition shadow-sm hover:shadow-md hover:translate-x-1.5 duration-200 group"
            >
              ...
              <ArrowRight className="h-4.5 w-4.5 text-brand-ink-soft ml-auto group-hover:text-brand-green-700 transition" />
            </a>
            ...
            <a 
              ...
              className="flex items-center gap-4 bg-white/95 rounded-2xl p-4 md:py-4.5 md:px-5.5 font-extrabold text-sm.5 text-brand-ink transition shadow-sm hover:shadow-md hover:translate-x-1.5 duration-200 group"
            >
              <span className="w-10.5 h-10.5 rounded-xl bg-brand-green-100 text-brand-green-700 flex items-center justify-center flex-shrink-0">
                <PhoneCall className="h-5 w-5" />
              </span>
              <span className="flex flex-col leading-snug">
                <b>สายด่วนแก้ปัญหา</b>
                <span className="text-[10.5px] text-brand-coral font-extrabold">โทรด่วน: 099-999-9999</span>
              </span>
              <ArrowRight className="h-4.5 w-4.5 text-brand-ink-soft ml-auto group-hover:text-brand-green-700 transition" />
            </a>

            {/* QR Code Card */}
            <div className="flex flex-col items-center bg-white/95 rounded-2xl p-4 shadow-sm text-center relative overflow-hidden group">
              <img 
                src="/qrcode.jpeg" 
                alt="LINE OA QR Code" 
