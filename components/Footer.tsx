...
export default function Footer() {
  ...
  const recommendedLinks = parsedLinks.length
    ? parsedLinks
    : DEFAULT_FOOTER_LINKS;
  const parsedServices = parseFooterLinks(config.footerServices);
  const serviceLinks = parsedServices.length
    ? parsedServices
    : DEFAULT_FOOTER_SERVICES;
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="flex h-12 w-12 flex-shrink-0 items-center">
                <img src={siteLogo} alt={siteTitle} className="h-full w-full object-contain" />
              </div>
